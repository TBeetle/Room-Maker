...
\node[furniture, rectangle, minimum width=24.00cm, minimum height=24.00cm, color=black](table) at (26,34.5) {};
\node[furniture-label, text=black ] at (table.center) {TABLE};
\node[furniture, rectangle, minimum width=24.00cm, minimum height=24.00cm, color=black](table) at (30,80.0) {};
\node[furniture-label, text=black ] at (table.center) {TABLE};
...
\node[furniture, rectangle, minimum width=18.00cm, minimum height=18.00cm, color=black](table) at (40,90.0) {};
\node[furniture-label, text=black ] at (table.center) {Table};
