...
\node[furniture, rectangle, minimum width=24.00cm, minimum height=24.00cm, color=red](table) at (26,34.5) {};
\node[furniture-label, text=red ] at (table.center) {TABLE};
\node[furniture, rectangle, minimum width=24.00cm, minimum height=24.00cm, color=red](table) at (30,80.0) {};
\node[furniture-label, text=red ] at (table.center) {TABLE};
\draw[wall, line width=2pt, line cap=round, color =teal] (0.00,0.00) -- (0.00,100.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (0.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (50.00,100.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (50.00,125.00) -- (100.00,125.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (100.00,125.00) -- (100.00,75.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (100.00,75.00) -- (100.00,75.00) coordinate (c);
\draw[window,line width=2pt, line cap=round, color=gray] (100.00,75.00) -- (100.00,25.00) coordinate (c);
\draw[window,line width=2pt, line cap=round, color=gray] (100.00,25.00) -- (100.00,25.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (100.00,25.00) -- (100.00,0.00) coordinate (c);
\draw[wall, line width=2pt, line cap=round, color =teal] (100.00,0.00) -- (0.00,0.00) coordinate (c);
