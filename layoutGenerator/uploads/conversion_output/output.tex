...
\node[furniture-label] at (table.center) {TABLE};
\draw[wall, line cap=round, color =brown] (0.00,0.00) -- (0.00,100.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (0.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (50.00,100.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (50.00,125.00) -- (100.00,125.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (100.00,125.00) -- (100.00,75.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (100.00,75.00) -- (100.00,75.00) coordinate (c);
...
\draw[wall, line cap=round, color =brown] (100.00,25.00) -- (100.00,0.00) coordinate (c);
\draw[wall, line cap=round, color =brown] (100.00,0.00) -- (0.00,0.00) coordinate (c);
