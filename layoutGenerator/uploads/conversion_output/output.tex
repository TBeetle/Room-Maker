...
\draw[window, line cap=round] (100.00,25.00) -- (50.00,30.00) coordinate (c);
\node[furniture, rectangle, minimum width=24.00cm, minimum height=24.00cm](table) at (50.0,30.0) {};
\node[furniture-label] at (table.center) {TABLE};
