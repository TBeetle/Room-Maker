	...
	\draw[line width=9pt, color=yellow, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=9pt, color=yellow] (#2, #3) circle (#1)
    }
    ...
    \node[location, color=orange](A1) at (72.0,100.0) {};
\node[location-label, text=orange] at (A1) {A1};
\camera[color=purple,rotate=90.0](72.0,72.0);
\node[camera-label, text=purple] at (72.0,72.0) {Camera A};
\node[sensor, color=pink](sensor) at (72.0,25.0) {};
\node[sensor-label,text=pink] at (72.00,25.00) {Sensor LW67756 \\ (72.00, 25.00)};
\furnitureR[height=24.0, width=24.0, rotate=0.0](26.0, 34.5);
\node[furniture-label, text=yellow ] at (26.0,34.5) {TABLE};
\furnitureC[radius=10.0](30.0, 80.0);
\node[furniture-label, text=yellow ] at (30.0,80.0) {TABLE};
\draw[wall, line width=7pt, line cap=round, color =blue] (0.00,0.00) -- (0.00,100.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (0.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (50.00,100.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (50.00,125.00) -- (100.00,125.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (100.00,125.00) -- (100.00,75.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (100.00,75.00) -- (100.00,75.00) coordinate (c);
\draw[window,line width=3pt, line cap=round, color=gray] (100.00,75.00) -- (100.00,25.00) coordinate (c);
\draw[window,line width=3pt, line cap=round, color=gray] (100.00,25.00) -- (100.00,25.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (100.00,25.00) -- (100.00,0.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (100.00,0.00) -- (75.00,0.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (75.00,0.00) -- (75.00,0.00) coordinate (c);
\draw[door, rotate around={10.00:(75.00,0.00)}, line width=4pt, color=violet] (75.00,0.00) -- ++(-50.00,0.00);
\draw[wall, line width=7pt, line cap=round, color =blue] (25.00,0.00) -- (0.00,0.00) coordinate (c);
\draw[wall, line width=7pt, line cap=round, color =blue] (0.00,0.00) -- (0.00,0.00) coordinate (c);
\draw[nav-arrow,color=teal] (125.0,25.0) -- ++(12,0) node[right, fill=white] {Room};
